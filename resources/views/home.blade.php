...
@section('content')
    ...
    <main id="main">
        ...
        <section class="py-4 col row" id="home" data-aos="fade-up">
            <h1 style="text-align: center; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Program
                Studi Teknologi Informasi</h1>
            <div class="container col-lg-8">
                <div class="carousel-container">
                    <div class="carousel-row">
                        ...
                        <div class="card mt-4 mx-4 shadow" style="width: 18rem; border: solid; border-radius: 10%;">
                            <img src="{{ asset('landing_page') }}/images/tekom.png" class="card-img-top mt-3"
                                alt="...">
                            <div class="card-body">
                    ...
                    <div class="carousel-row">
                        ...
                        <div class="card mt-4 mx-4 shadow" style="width: 18rem; border: solid; border-radius: 10%;">
                            <img src="/landing_page/images/jaringan.png" class="card-img-top mt-3" alt="...">
                            <div class="card-body">
        ...
        <script>
            ...
            function slideCarousel() {
                ...
                cards.forEach((card, index) => {
                    var scale = index === currentIndex ? 1 :
                    0.8; // Skala card yang aktif adalah 1, sedangkan yang lain adalah 0.8
                    var opacity = index === currentIndex ? 1 :
                    0.5; // Opacity card yang aktif adalah 1, sedangkan yang lain adalah 0.5
                    var boxShadow = index === currentIndex ? '0 8px 16px rgba(0,0,0,0.2)' :
                    '0 4px 6px rgba(0,0,0,0.1)'; // Shadow yang aktif adalah lebih tebal
...
<style>
    @keyframes borderRunning {
        5% { border-color: #fb00ff; }
        20% { border-color: #00f2ff; }
        40% { border-color: #dc3545; }
        60% { border-color: #5507ff; }
        80% { border-color: #00ff95; }
    ...
    .card {
        ...
        animation: borderRunning 5s infinite; /* Animasi borderRunning selama 5 detik secara berulang */
    }
    ...
    .active {
        ...
        animation: none; /* Menghentikan animasi saat card aktif */
    }
